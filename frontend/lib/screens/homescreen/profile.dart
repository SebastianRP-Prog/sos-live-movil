...
const List<_AvatarOption> _kAvatars = [
  ...
  _AvatarOption('butterfly_pink',  Icons.filter_vintage_rounded,   Color(0xFFE91E63)),
  ...
  _AvatarOption('fire_deep',       Icons.local_fire_department_rounded, Color(0xFFBF360C)),
  ...
  _AvatarOption('basketball_orng', Icons.sports_basketball_rounded,Color(0xFFE65100)),
  ...
  _AvatarOption('rocket_purple',   Icons.rocket_launch_rounded,    Color(0xFF6A1B9A)),
  ...
  _AvatarOption('crown_gold',      Icons.workspace_premium_rounded,Color(0xFFF9A825)),
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> _handleChangeAvatar() async {
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Icon(opt.icon,
                                  color: Colors.white, size: isActive ? 30 : 26),
                            ),
                          );
                        },
                      ),
    ...
    try {
      await FirebaseFirestore.instance.collection('users').doc(uid).update({'avatarId': selected});
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // Campo Nombre
                  _dialogField(
                    nameCtrl, Icons.person, 'Nombre Completo',
                    errorText: nameError,
  ...
  Future<void> _handleChangePassword() async {
    final confirmed = await _showConfirmDialog(
      ...
      message: 'Te enviaremos un correo a\n$email\npara restablecer tu contraseña.',
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              prefixIcon: Icon(icon, color: errorText != null ? Colors.redAccent : gold),
              hintText: hint,
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              _buildDrawerItem(icon: Icons.policy_outlined,          title: 'Políticas de la Empresa',  onTap: () => Navigator.pop(context)),
              _buildDrawerItem(icon: Icons.gavel_outlined,           title: 'Términos y Condiciones',   onTap: () => Navigator.pop(context)),
              _buildDrawerItem(icon: Icons.help_outline,             title: 'Centro de Ayuda',          onTap: () => Navigator.pop(context)),
              _buildDrawerItem(icon: Icons.lock_reset,               title: 'Cambiar Contraseña',       onTap: () { Navigator.pop(context); _handleChangePassword(); }),
              if (!isVerified)
                _buildDrawerItem(
                  icon: Icons.mark_email_unread_outlined,
                  title: 'Verificar Email',
                  color: Colors.orangeAccent,
                  onTap: () { Navigator.pop(context); _handleVerifyEmail(); },
                ),
              const Spacer(),
              ...
              _buildDrawerItem(
                ...
                title: 'Eliminar Cuenta',
                color: Colors.red,
                onTap: () { Navigator.pop(context); _handleDeleteAccount(); },
              ),
              _buildDrawerItem(icon: Icons.logout, title: 'Cerrar Sesión', color: Colors.redAccent, onTap: _handleLogout),
                      ...
                      child: Column(
                        children: [
                          Align(
                            ...
                            child: Builder(
                              builder: (context) => IconButton(
                                icon: const Icon(Icons.menu, size: 35, color: darkBlue),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(color: avatar.bg.withOpacity(0.4), blurRadius: 20, spreadRadius: 4),
                                  ],
                                ),
                                child: Icon(avatar.icon, size: 90, color: Colors.white),
                              ),
                              if (isVerified)
                                Positioned(
                                  bottom: 12,
                              ...
                              Positioned(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Icon(Icons.color_lens_rounded, color: Colors.black, size: 18),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              const Icon(Icons.email_outlined, color: gold, size: 16),
                          ...
                          _buildMenuOption(Icons.edit,                    'Editar Perfil',      onTap: _handleEditProfile),
                          _buildMenuOption(Icons.color_lens_rounded,      'Cambiar Avatar',     onTap: _handleChangeAvatar),
                          _buildMenuOption(Icons.lock_reset,              'Cambiar Contraseña', onTap: _handleChangePassword),
                          _buildMenuOption(Icons.play_circle_outline,     'Simulación SOS',     onTap: _handleSimulation),
                          _buildMenuOption(Icons.history,                 'Historial',          onTap: _handleHistory),
                          if (!isVerified)
                            _buildMenuOption(Icons.mark_email_unread_outlined, 'Verificar Email',
                                onTap: _handleVerifyEmail, iconColor: Colors.orangeAccent),
...
class ProfileWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.25, waveHeight - 45, size.width * 0.5, waveHeight);
    path.quadraticBezierTo(size.width * 0.75, waveHeight + 45, size.width, waveHeight);
